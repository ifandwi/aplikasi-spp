              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 style="color: #000000; font-size: 18px; font-weight: bold;">LIST SPP</h4>
                    <div class="card-header-form">
                      <form>
                          <div class="input-group-btn">
                            <a href="tambah_spp.php" class="btn" style="background-color: #0996e8;"><i class="fas fa-plus"></i></a>
                        </div>
                      </form>
                    </div>
                  </div>
                      ...
                      <table class="table table-striped">
                       <thead>
                        ...
                        <tr>  
                          ...
                          <td>
                          <a href="edit_spp.php?id=<?php echo $row['id_spp']; ?>"class="btn" style="background-color: #0996e8;"><i class="fas fa-edit"></i></a>
