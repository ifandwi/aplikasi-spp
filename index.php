        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-info">
              <div class="card-header d-flex justify-content-center"><h4>MASUK SEBAGAI ADMIN</h4></div>
              ...
              <div class="card-body">
               ...
               <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <a href="loginSiswa.php" class="text-primary d-flex justify-content-center" style="padding-top: 20px; position: relative; top: 5px;">Login sebagai Siswa</a>
                  </div>
                </form>
