        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-info">
              <div class="card-header d-flex justify-content-center"><h4>MASUK SEBAGAI SISWA</h4></div>

              <div class="card-body">
               <form action="cekSiswa.php" method="post">
      		 			<div class="form-group">
      		 				<label><span class="text-danger">* </span>NISN</label>
      		 				<div class="input-group">
      		 				<input type="text" name="nisn" class="form-control" placeholder="Masukkan NISN anda..." required="required">
      		 				</div>
      		 			</div>

               <div class="form-group">
         				<label><span class="text-danger">* </span>NIS</label>
         				<div class="input-group">
        		 				<input type="text" name="nis" class="form-control" placeholder="Masukkan NIS anda..." required="required">
        		 			</div>
        		 		</div>
                  ...
                  <div class="form-group">
                    ...
                    <a href="index.php" class="text-primary d-flex justify-content-center" style="padding-top: 20px; position: relative; top: 5px;">Login sebagai Admin</a>
                  </div>
                </form>
