                    ...
                    <div class="card-header-form">
                      <form>
                          <div class="input-group-btn">
                            <a href="tambah_kelas.php" class="btn" style="background-color: #0996e8;"><i class="fas fa-plus"></i></a>
                        </div>
                      </form>
                    </div>
                  </div>
                      ...
                      <table class="table table-striped">
                       <thead>
                        ...
                        <tr>  
                          ...
                          <a href="edit_kelas.php?id=<?php echo $row['id_kelas']; ?>"class="btn" style="background-color: #0996e8;"><i class="fas fa-edit"></i></a>
                          <a href="angkatan.php?id=<?php echo $row['id_kelas']; ?>"class="btn" style="background-color: #0996e8;">DETAIL</a>
