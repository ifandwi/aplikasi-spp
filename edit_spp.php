          ...
          <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body" style="background-color: #0996e8;">
                    <div class="row mt-4">
                    ...
                    <form class="wizard-content mt-2" method="post" action="proses_editspp.php">
                      <div class="wizard-pane">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4 col-md-6 text-right mt-4">
                            <button type="submit" class="btn btn-icon icon-left btn-primary" style="margin-right: 8px;"><i class="fas fa-arrow-left"></i>KEMBALI</button>
                            <button type="submit" class="btn btn-icon icon-right btn-primary">UBAH NOMINAL<i class="fas fa-arrow-right"></i></button>
                          </div>
                        </div>
                      </div>
                    </form>
